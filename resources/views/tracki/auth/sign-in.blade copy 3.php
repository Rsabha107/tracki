                                    ...
                                    <div class="auth-form-box">
                                        <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="{{ route('login') }}">
                                                <div class="d-flex align-items-center fw-bolder fs-5 d-inline-block">
                                                    <img src="{{asset('assets/img/spot-illustrations/logo_printemps.jpg')}}" alt="Tracki" width="58" />
                                                </div>
                                            </a>
                                        ...
                                        <div class="row flex-between-center mb-7">
                                            ...
                                            <div class="col-auto"><a class="fs--1 fw-semi-bold" href="{{route('tracki.auth.forgot')}}">Forgot
                                                    Password?</a></div>
                                        </div>
                                        <button class="btn btn-primary w-100 mb-3">Sign In</button>
                                        <!-- <div class="text-center"><a class="fs--1 fw-bold"
                                                href="{{route('tracki.auth.signup')}}">Create an
                                                account</a></div> -->
                                        </form>
                                    </div>
                                </div>
