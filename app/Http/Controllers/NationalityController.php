...
class NationalityController  extends Controller
{
    ...
    {
        return view('tracki.setting.nationalities.list');
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $op = Nationality::findOrFail($request->id);
    ...
    public function list()
    {
        ...
        $op = Nationality::orderBy($sort, $order);
        ...
        $op = $op->paginate(request("limit"))->through(function ($op) {
            ...
            return [
                ...
                'nationality' => '<div class="align-middle white-space-wrap fw-bold fs-8 ms-3">' . $op->nationality . '</div>',
