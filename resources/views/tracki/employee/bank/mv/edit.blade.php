...
<div class="modal-body">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12 mb-3">
            ...
            <input name="bank_branch_name" class="form-control" type="text" placeholder="" value="{{$employee_bank->bank_branch_name}}" required>
            <!-- <div class="invalid-feedback">This field is required.</div> -->
        </div>
        <div class="col-md-12 mb-3">
            <label class="form-label" for="inputEmail4">Bank Account Name</label>
            <input name="bank_account_name" class="form-control" type="text" placeholder="" value="{{$employee_bank->bank_account_name}}" required>
            <!-- <div class="invalid-feedback">This field is required.</div> -->
        </div>
        <div class="col-md-12 mb-3">
            <label class="form-label" for="inputEmail4">IBAN</label>
            <input name="iban" class="form-control" type="text" placeholder="" value="{{$employee_bank->iban}}" maxlength="29" required>
            <!-- <div class="invalid-feedback">This field is required.</div> -->
        </div>
        <div class="col-md-12 mb-3">
            <label class="form-label" for="inputEmail4">Swift Code</label>
            <input name="swift_code" class="form-control" type="text" placeholder="" value="{{$employee_bank->swift_code}}" maxlength="8" required>
            <!-- <div class="invalid-feedback">This field is required.</div> -->
        </div>
        <!-- </div> -->
    </div>
