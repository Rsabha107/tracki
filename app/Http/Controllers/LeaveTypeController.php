...
class LeaveTypeController extends Controller
{
    ...
    {
        return view('tracki.setting.leave_types.list');
    }

    public function get($id)
    {
        $op = EmployeeLeaveType::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $error = true;
            // $message = 'Leave Type not create.';
            $message = implode($validator->errors()->all());
        } else {
            $user_id = Auth::user()->id;
            $op = EmployeeLeaveType::findOrFail($request->id);
    ...
    public function list()
    {
        ...
        $op = EmployeeLeaveType::orderBy($sort, $order);
    ...
    {
        EmployeeLeaveType::where('id', '=', $id)->delete();
