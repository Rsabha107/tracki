(function (global, factory) {
    ...
    const orders = [
        {
            ...
            date: "10/03/2023",
            address:
                "Carry Anna, 2392 Main Avenue, Penasauka, New Jersey 02149",
        ...
        },
        {
            ...
            date: "30/04/2023",
            address:
                "Igor Borvibson, 1 Infinite Loop, Cupertino, California 90210",
            deliveryType: "Free Shipping",
            status: "Processing",
            badge: { type: "primary", icon: "fas fa-redo" },
            amount: "$145",
        ...
        },
        {
            ...
            date: "29/04/2023",
            address:
                "Roy Anderson, 1 Infinite Loop, Cupertino, California 90210",
            deliveryType: "Local Delivery",
            status: "On Hold",
            badge: { type: "secondary", icon: "fas fa-ban" },
            amount: "$90",
        ...
        },
        {
            ...
            date: "28/04/2023",
            address:
                "Demarcus Okuneva, 90555 Upton Drive Jeffreyview, UT 08771",
            deliveryType: "Flat Rate",
            status: "Completed",
            badge: { type: "success", icon: "fas fa-check" },
            amount: "$99",
        ...
        },
        {
            ...
            date: "23/04/2023",
            address:
                "Garry Brainstrow, 13572 Kurt Mews South Merritt, IA 52491",
            deliveryType: "Free Shipping",
            status: "Completed",
            badge: { type: "success", icon: "fas fa-check" },
            amount: "$139",
        ...
        },
        {
            ...
            date: "22/04/2023",
            address:
                "Laverne Haag, 2327 Kaylee Mill East Citlalli, AZ 89582-3143",
            deliveryType: "Flat Rate",
            status: "On Hold",
            badge: { type: "secondary", icon: "fas fa-ban" },
            amount: "$49",
        ...
        $echartBasicCharts.forEach(($echartBasicChart) => {
            ...
            const getDefaultOptions = () => ({
                ...
                xAxis: {
                    ...
                    axisLabel: {
                        formatter: (value) =>
                            window.dayjs(value).format("DD MMM"),
                        interval: 6,
                        showMinLabel: true,
                        showMaxLabel: true,
  ...
  -----------------------------------------------*/
    ...
    /* -------------------------------------------------------------------------- */
    const choicesInit = () => {
        const { getData, hasClass } = window.phoenix.utils;
        ...
        if (window.Choices) {
            ...
            elements.forEach((item) => {
                ...
                // console.log(hasClass(item, "test"));
                // console.log(getData(item, "options"));

                // console.log(choices);
                if (hasClass(item, "test")) {
                    $(".test").data("choiceobject", choices);
                }
                // item.data('choiceobject', choices)
                // console.log($(".test").data("choices"));
                // console.log($(".test").data("choiceobject"));
                // console.log(elements);
                // window.choiceObject = choices;
    ...
    const createBoardInit = () => {
        ...
        if (createBoard) {
            ...
            const boardPrevButton = document.querySelector(
                selectors.BOARD_PREV_BTN
            );
            ...
            if (tabToggleButtonEl.length) {
                tabToggleButtonEl.forEach((item) => {
                    item.addEventListener(events.SHOW, () => {
                        ...
                        const kanbanStep = document.querySelector(
                            selectors.KANBAN_STEP
                        );
                        if (kanbanStep) {
        ...
        if (navbarArea) {
            navbarArea.addEventListener("mouseover", (e) => {
                if (
                    ...
                    const dropdownInstance = new window.bootstrap.Dropdown(
                        e.target
                    );
  ...
  -----------------------------------------------*/
                ...
                const options = merge$1(
                    {
                        ...
                        previewsContainer: item.querySelector(
                            Selector.DZ_PREVIEW
                        ),
    ...
    const flatpickrInit = () => {
        const { getData } = window.phoenix.utils;
    // console.log('phoenix.js flatpickrInit***********************************')
            ...
            window.flatpickr(item, {
                ...
                onDayCreate: (dObj, dStr, fp, dayElem) => {
                    if (
                        ...
                        dayElem.className += " weekend-daysx";
                    }
                },
                ...userOptions,
            });
    ...
    const flatpickrStartTodayInit = () => {
        const { getData } = window.phoenix.utils;
    // console.log('phoenix.js flatpickrInit***********************************')

        document.querySelectorAll(".datetimepickerstarttoday").forEach((item) => {
            const userOptions = getData(item, "options");
            window.flatpickr(item, {
                // nextArrow: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z"/></svg>`,
                // prevArrow: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"><!--! Font Awesome Pro 6.1.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M224 480c-8.188 0-16.38-3.125-22.62-9.375l-192-192c-12.5-12.5-12.5-32.75 0-45.25l192-192c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L77.25 256l169.4 169.4c12.5 12.5 12.5 32.75 0 45.25C240.4 476.9 232.2 480 224 480z"/></svg>`,
  ...
  -----------------------------------------------*/
    ...
    function initMap() {
        ...
        if ($googlemaps.length && window.google) {
            ...
            $googlemaps.forEach((itm) => {
                ...
                map.controls[window.google.maps.ControlPosition.LEFT].push(
                    controlDiv
                );
    ...
    const iconCopiedInit = () => {
        ...
        const iconCopiedToast = document.getElementById("icon-copied-toast");
        const iconCopiedToastInstance = new window.bootstrap.Toast(
            iconCopiedToast
        );
  ...
  -----------------------------------------------*/
            ...
            masonryItems.length &&
                masonryItems.forEach((masonryItem) => {
                    window.imagesLoaded(masonryItem, () => {
                        ...
                        const options = window._.merge(
                            defaultOptions,
                            userOptions
                        );
                        const isotope = new window.Isotope(
                            masonryItem,
                            options
                        );
                        ...
                        filterElement?.addEventListener("click", function (e) {
                            ...
                            document
                                .querySelectorAll(Selector.DATA_FILTER)
                                .forEach((el) => {
        ...
        if (window.List) {
            ...
            if (lists.length) {
                lists.forEach((el) => {
                    ...
                    const viewLess = el.querySelector(
                        '[data-list-view="less"]'
                    );
                    ...
                    if (options.filter) {
                        ...
                        listFilter.addEventListener("change", (e) => {
                            list.filter((item) => {
                                ...
                                pageQuantity = Math.ceil(
                                    list.matchingItems.length / list.page
                                );
                                pageCount = 1;
                                updateListControls();
                                return item
        ...
        if ($modals) {
            ...
            $modals.forEach((modal) => {
                ...
                if (options.autoShow) {
                    ...
                    const disableAutoShowModalCookie = getCookie(
                        "disableAutoShowModal"
                    );
    ...
    const navbarComboInit = () => {
        ...
        const moveNavContent = (windowWidth) => {
            ...
            if (windowWidth < navbarTopBreakpoint) {
                const navbarCollapse = navbarTopCombo.querySelector(
                    Selector.COLLAPSE
                );
    ...
    const handleNavbarVerticalCollapsed = () => {
        const { getItemFromStore, setItemToStore, resize } =
            window.phoenix.utils;
        const Selector = {
            HTML: "html",
            BODY: "body",
        ...
        const setDocumentMinHeight = () => {
            const bodyHeight = document.querySelector(
                Selector.BODY
            ).offsetHeight;
  ...
  -----------------------------------------------*/
    ...
    const phoenixOffcanvasInit = () => {
        ...
        const offcanvasBodyScroll = document.querySelector(
            "[data-phoenix-scroll]"
        );
        ...
        if (toggleEls) {
            toggleEls.forEach((toggleEl) => {
                ...
                const offcanvasTargetEl =
                    document.querySelector(offcanvasTarget);
  ...
  -----------------------------------------------*/
    ...
    const productDetailsInit = () => {
        ...
        const productDetailsEl = document.querySelector(
  ...
  -----------------------------------------------*/
    ...
    const responsiveNavItemsInit = () => {
        ...
        const navbar = () => {
            ...
            const categoryBtn = navbarEl.querySelector(
                Selector.CATEGORY_BUTTON
            );
        ...
        if (navbarEl) {
            ...
            resize(() => {
                const navElements = navbarEl.querySelectorAll(
                    Selector.NAV_ITEM
                );
                const dropElements = navbarEl.querySelectorAll(
    ...
    const searchInit = () => {
        ...
        const hideSearchSuggestion = (searchArea) => {
            ...
            const dropdownMenu = searchArea.querySelector(
        ...
        searchAreas.forEach((searchArea) => {
            ...
            if (input) {
                input.addEventListener(Events.FOCUS, () => {
                    hideAllSearchAreas();
                    const el = searchArea.querySelector(
                        Selectors.SEARCH_TOGGLE
                    );
                    if (!el || !dropdownMenu) return;
  ...
  -----------------------------------------------*/
    ...
    const initialDomSetup = (element) => {
        const { getData, getItemFromStore, getSystemTheme } =
            window.phoenix.utils;
        if (!element) return;
        ...
        element.querySelectorAll("[data-theme-control]").forEach((el) => {
            ...
            const currentNavbarPosition = getItemFromStore(
    ...
    const changeTheme = (element) => {
        ...
        element
            ...
            .forEach((el) => {
                const inputDataAttributeValue = getData(el, "theme-control");
                const localStorageValue = getItemFromStore(
            ...
            if (target.data("theme-control")) {
                ...
                switch (control) {
                    ...
                    case "phoenixNavbarTopShape":
                        {
                            if (
                                getItemFromStore("phoenixNavbarPosition") ===
                                "dual-nav"
                            ) {
                                el.setAttribute("disabled", true);
                ...
                const options = merge(
                    {
                        ...
                        directionality: getItemFromStore("phoenixIsRTL")
                            ? "rtl"
                            : "ltr",
                        toolbar: [
            ...
            if (themeController) {
                themeController.addEventListener(
                    ...
                    ({ detail: { control } }) => {
                        if (control === "phoenixTheme") {
                            tinymces.forEach((tinymceEl) => {
                                const instance = window.tinymce.get(
                                    tinymceEl.id
                                );
    ...
    const todoOffcanvasInit = () => {
        ...
        if (todoList) {
            ...
            offcanvasToggles.forEach((toggle) => {
                ...
                const todoOffcanvas = new window.bootstrap.Offcanvas(
                    offcanvasEl,
                    {
                        backdrop: true,
                    }
    ...
    const wizardInit = () => {
        ...
        wizards.forEach((wizard) => {
            ...
            const passwordInput = wizard.querySelector(
            ...
            const hasWizardModal = wizard.hasAttribute(
            ...
            forms.forEach((form) => {
                form.addEventListener(events.SUBMIT, (e) => {
                    ...
                    count += 1;
                    // console.log('2 incrementing count')
                    // console.log('3 count:'+count)
                    $("#add_employee_date_of_birth").attr("required", "true");
                    $("#add_employee_gender").attr("required", "true");
                    $("#add_employee_marital_status").attr("required", "true");
                    $("#add_employee_nationality").attr("required", "true");
            ...
            nextButton.addEventListener(events.CLICK, () => {
                ...
                // console.log('5 tabs.length: '+tabs.length)
                if (count + 1 < tabs.length) {
                    // console.log('progress 4 count:'+(count+1))
                    tabs[count + 1].show();
                }
            });

            // console.log('6 count after nextButton.addEventListener: '+count)
            ...
            if (tabToggleButtonEl.length) {
                tabToggleButtonEl.forEach((item, index) => {
                    ...
                    item.addEventListener(events.SHOWN, () => {
                        ...
                        // can't go back tab
                        // if (
                        //     count === tabToggleButtonEl.length - 1 &&
                        //     !hasWizardModal
                        // ) {
                        ...
                        for (let i = 0; i < count; i += 1) {
                            ...
                            if (i > 0) {
                                tabToggleButtonEl[i - 1].classList.add(
                                    "complete"
                                );
                            }
                        }
                        ...
                        // console.log('8 prevButton: '+prevButton)
                        // console.log('9 tabToggleButtonEl.length: '+tabToggleButtonEl.length)
                        if (prevButton) {
                            if (
                                count > 0 &&
                                count !== tabToggleButtonEl.length - 1
                                ...
                                // console.log('10 adding d-none to prev button')
                                if (count > 0){
    ...
    const kanbanInit = () => {
        ...
        if (kanbanContainer) {
            ...
            const kanbanGroups =
                kanbanContainer.querySelectorAll("[data-sortable]");
        ...
        if (verificationForm) {
            ...
            inputFields.forEach((input, index) => {
                input.addEventListener("keyup", (e) => {
                    ...
                    if (value) {
                        [...value]
                            .slice(0, totalInputLength)
                            .forEach((char, charIndex) => {
                                if (
                                    inputFields &&
                                    inputFields[index + charIndex]
                                ) {
    ...
    const flightMapInit = () => {
        ...
        if (flightMap) {
            ...
            const lineDistance = window.turf.length(
    ...
    const priceTierFormInit = () => {
        const priceTierForms = document.querySelectorAll(
            "[data-form-price-tier]"
        );
        if (priceTierForms) {
            priceTierForms.forEach((priceTierForm) => {
                const priceToggler = priceTierForm.querySelector(
                    "[data-price-toggle]"
                );
                const pricings =
                    priceTierForm.querySelectorAll("[data-pricing]");
                const bottomOption = priceTierForm.querySelector(
                    "[data-pricing-collapse]"
                );

                const pricingCollapse = new window.bootstrap.Collapse(
                    bottomOption,
                    {
                        toggle: false,
                    }
    ...
    const collapseAllInit = () => {
        ...
        if (collapseParent) {
            const collapseElements =
                collapseParent.querySelectorAll(".collapse");
    ...
    const tripReviewChartInit = () => {
        ...
        const $echartTripReviews = document.querySelectorAll(
            ".echart-trip-review"
        );
    ...
    const passwordToggleInit = () => {
        ...
        if (passwords) {
            passwords.forEach((password) => {
                const passwordInput = password.querySelector(
                    "[data-password-input]"
                );
    ...
    docReady(flatpickrStartTodayInit);
