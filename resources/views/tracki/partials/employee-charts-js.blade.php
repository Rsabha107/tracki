<script>
    (function(factory) {
      ...
      ${el.date.format('MMM DD')} : ${el.value}
        ...
        /* -------------------------------------------------------------------------- */
        /*                       Echarts Employee Entity pie                          */
        /* -------------------------------------------------------------------------- */
        const employeeEntitypieLabelAlignChartInit = () => {
            const {
                getColor,
                getData,
                rgbaColor
            ...
            const $chartEl = document.querySelector(
                '.echart-employee-entity-pie-label-align-chart'
            );

            const data = <?php echo json_encode($employee_entity_chart); ?>
        ...
        /* -------------------------------------------------------------------------- */
        /*                       Echarts Employee Direcotrate pie                     */
        /* -------------------------------------------------------------------------- */
        const employeeDirectoratepieLabelAlignChartInit = () => {
            const {
                getColor,
                getData,
                rgbaColor
            ...
            const $chartEl = document.querySelector(
                '.echart-employee-directorate-pie-label-align-chart'
            );

            const data = <?php echo json_encode($employee_directorate_chart); ?>
        ...
        /* -------------------------------------------------------------------------- */
        /*                   Echarts Employee Functional Area pie                     */
        /* -------------------------------------------------------------------------- */
        const employeeFuncationalAreapieLabelAlignChartInit = () => {
            const {
                getColor,
                getData,
                rgbaColor
            ...
            const $chartEl = document.querySelector(
                '.echart-employee-functional-area-pie-label-align-chart'
            );

            const data = <?php echo json_encode($employee_functional_area_chart); ?>
        ...
        /* -------------------------------------------------------------------------- */
        /*                             Echarts Employee Department pie                */
        /* -------------------------------------------------------------------------- */
        const employeeDepartmentpieLabelAlignChartInit = () => {
            const {
                getColor,
                getData,
                rgbaColor
            ...
            const $chartEl = document.querySelector(
                '.echart-employee-department-pie-label-align-chart'
            );

            const data = <?php echo json_encode($employee_department_chart); ?>
      ...
      ${el.date.format('MMM DD')} : ${el.value}
        ...
        const totalSalesByMonthChartInit = () => {
            ...
            const data = <?php echo json_encode($employees_by_month); ?>;
        ...
        const totalProjectByMonthChartInit = () => {
            ...
            const totalOrdersChartEl = document.querySelector('.echart-total-employees-by-month');
            ...
            if (spendByDepartment) {
                ...
                const getDefaultOptions = () => ({
                    ...
                    series: [{
                        ...
                        data: <?php echo json_encode($employees_by_month); ?>
                        //  [
        ...
        const employeeNationalityChartInitBig = () => {
            const {
                getColor,
                getData
            } = window.phoenix.utils;
            const $chartEl = document.querySelector('.echart-employee-nationalities-bar');

            const count_data = <?php echo json_encode($count_of_nationality); ?>;
            const nationality_data = <?php echo json_encode($nationality_name); ?>;

            const nationality_bar = <?php echo json_encode($nationality_bar); ?>;
            ...
            if ($chartEl) {
                ...
                const getDefaultOptions = () => ({
                    dataset: [{
                            dimensions: ['name', 'value', 'country_name'],
                            source: nationality_bar
                        },
                        {
                            transform: {
                                type: 'sort',
      ...
      ${el.date.format('MMM DD')} : ${el.value}
        ...
        docReady(employeeDepartmentpieLabelAlignChartInit);
        docReady(employeeFuncationalAreapieLabelAlignChartInit);
        docReady(employeeDirectoratepieLabelAlignChartInit);
        docReady(employeeEntitypieLabelAlignChartInit);
        docReady(employeeNationalityChartInitBig);
