...
<link href="{{asset ('assets/vendors/fullcalendar/main.min.css')}}" rel="stylesheet">
...
<!-- <link href="{{ asset ('assets/datatables/Buttons-2.4.2/buttons.dataTables.min.css') }}" rel="stylesheet"> -->
...
<!-- <link href="{{ asset ('assets/css/gantt.css') }}" type="text/css" rel="stylesheet" id="user-style-rtl"> -->
