...
class MaritalStatusController extends Controller
{
    ...
    {
        return view('tracki.setting.marital.list');
    }

    public function get($id)
    {
        $op = MaritalStatus::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $error = true;
            // $message = 'MaritalStatus not create.';
            $message = implode($validator->errors()->all());
        } else {
            $user_id = Auth::user()->id;
            $op = MaritalStatus::findOrFail($request->id);

            $error = false;
            $message = 'MaritalStatus updated.';
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            // Log::info($validator->errors());
            $error = true;
            // $message = 'MaritalStatus could not be created';
            $message = implode($validator->errors()->all());
        } else {

            $error = false;
            $message = 'MaritalStatus created.';
    ...
    public function list()
    {
        ...
        $op = MaritalStatus::orderBy($sort, $order);
