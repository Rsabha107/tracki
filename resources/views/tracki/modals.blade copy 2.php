...
<div class="offcanvas offcanvas-start w-50" id="offcanvasAddEditProject" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasWithBackdropLabel">Create new project</h5>
        <button class="btn-close text-reset" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">

    <h4 class="mb-3">Information </h4>
        <form class="row g-3 needs-validation form-submit-eventxx" id="add_new_project" novalidate="" action="{{ route ('main.project.create') }}" method="POST">
            @csrf
            <input type="hidden" name="table" value="task_table">

            <div class="col-md-12">
                <label class="form-label" for="inputEmail4">Title</label>
                <input name="name" id="create_project_name" class="form-control" type="text" placeholder="" required>
            </div>
            <div class="col-3">
                <label class="form-label" for="inputAddress">Project type</label>
                <select name="project_type" class="form-select" id="floatingSelectRating" required>
            ...
            <div class="col-3">
                ...
                <select name="category_id" class="form-select" id="floatingSelectRating" required>
                    <option selected="selected" value="">Select...</option>
            ...
            <div class="col-3">
                ...
                <select name="audience_id" class="form-select" id="floatingSelectRating" required>
                    <option selected="selected" value="">Select...</option>
            ...
            <div class="col-3">
                <label class="form-label" for="inputAddress">Planner</label>
                <select name="planner_id" class="form-select" id="floatingSelectRating" required>
                    <option selected="selected" value="">Select...</option>
            ...
            <div class="col-3">
                ...
                <select name="venue_id" class="form-select" id="floatingSelectRating" required>
                    <option selected="selected" value="">Select...</option>
            ...
            <div class="col-3">
                ...
                <select name="location_id" class="form-select" id="floatingSelectRating" required>
                    <option selected="selected" value="">Select...</option>
            ...
            <div class="col-3">
                ...
                <select name="fund_category_id" class="form-select" id="floatingSelectRating" required>
                    <option selected="selected" value="">Select...</option>
            ...
            <div class="col-md-6">
                ...
                <input name="attendance_forcast" class="form-control" id="floatingInputLinkedin" type="number" step="0.01" placeholder="linkedin" value="0" required>
            </div>
            <div class="col-12">
...
<div class="offcanvas offcanvas-start w-50" id="offcanvasEditProject" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">

    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasWithBackdropLabel"> Edit project</h5>
        <button class="btn-close text-reset" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
    ...
    <h4 class="mb-3">Information </h4>
        <form class="row g-3 needs-validation form-submit-eventxx" id="add_new_project" novalidate="" action="{{ route ('main.project.create') }}" method="POST">
            ...
            <div class="col-md-12">
                <label class="form-label" for="inputEmail4">Title</label>
                <input name="name" id="edit_project_name" class="form-control" type="text" placeholder="" required>
            </div>
            <div class="col-3">
                <label class="form-label" for="inputAddress">Project type</label>
                <select name="project_type" class="form-select" id="floatingSelectRating" required>
            ...
            <div class="col-12 d-flex justify-content-end mt-6">
                <button class="btn btn-phoenix-secondary action button-submit" type="submit" value="save" id="submit_btn">Save</button>
                <!-- <button class="btn btn-phoenix-danger action" type="button" data-bs-dissmiss="offcanvas">Cancel</button> -->
                <!-- <button class="btn-close text-reset" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button> -->
                <!-- <a class="btn btn-phoenix-danger me-2 px-6"  href="#">Cancel</a> -->
                <!-- <button class="btn btn-primary action" type="submit" value="publish">Publish</button> -->
            </div>
...
<div class="modal fade" id="create_workspace_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content form-submit-event" id="form_submit_event" action="{{route('main.setup.workspace.store')}}" method="POST">
...
<div class="modal fade" id="edit_workspace_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content form-submit-event" id="form_submit_event" action="{{route('main.setup.workspace.update')}}" method="POST">
            <input type="hidden" name="table" value="workspace_table">
...
<div class="modal fade" id="createTodoModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-top">
        <div class="modal-content bg-100">
            ...
            <form class="needs-validation form-submit-eventx" id="add_new_todo" novalidate="" action="{{ route('main.todo.store') }}" method="POST">
                @csrf
                <div class="modal-body">
...
<div class="offcanvas offcanvas-start" id="offcanvasCreateTask" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    @if (Request::is('main/task/*/list'))
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasWithBackdropLabel">Create new task for {{Session::get('record_type')}} ( {{$eventData->name}} )</h5>
        <button class="btn-close text-reset" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    ...
    <div class="offcanvas-body">
        ...
        <form class="row g-3 needs-validation form-submit-event" id="add_new_task" novalidate="" action="{{ route('main.task.store') }}" method="POST">
            @csrf
            @if (Request::is('main/task/*/list'))
            ...
            <div class="col-md-12">
                <label class="form-label" for="inputEmail4">Title</label>
                <input name="name" id="create_task_name" class="form-control" type="text" placeholder="" required>
            </div>
            ...
            <div class="col-12">
                ...
                <select required class="form-select js-example-basic-multiple" name="assignment_to_id[]" multiple="multiple" data-with="100%" data-placeholder="<?= get_label('type_to_search', 'Type to search') ?>">
...
<!-- edit task used in list and manage -->
<div class="offcanvas offcanvas-start" id="offcanvasAddEditTask" tabindex="-1" aria-labelledby="offcanvasWithBackdropLabel">
    ...
    <div class="offcanvas-body">
        ...
        <form class="row g-3 needs-validation form-submit-event" id="add_edit_task_form" novalidate="" action="" method="POST">
            ...
            <input type="hidden" id="add_edit_table_h" name="table" value="">
            ...
            <div class="col-md-6">
                <label class="form-label" for="inputCity">Budget allocated</label>
                <input name="budget_allocation" class="form-control" id="add_edit_task_budget" type="number" step="0.01" placeholder="linkedin" value="0" required>
            </div>
            <div class="col-md-6">
                <label class="form-label" for="inputState">Actual budget utilized</label>
                <input name="actual_budget_allocated" class="form-control" id="add_edit_task_budget_utilization" type="number" step="0.01" placeholder="linkedin" value="0" required>
            </div>
            <div class="col-12">
                <label class="form-label" for="gridCheck">Description</label>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content overflow-hidden">
            <div class="modal-header position-relative p-0">
                <h5 class="modal-title ms-3">Task details</h5>
