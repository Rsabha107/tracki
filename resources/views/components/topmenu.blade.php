...
<nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault">
    <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="{{ route('tracki.employee.dashboard') }}">
                <div class="d-flex align-items-center">
                    ...
                    >
                        ...
                        <img src="{{ asset ('assets/img/icons/sparkle_hrms.jpg') }}" alt="phoenix" width="40" height="20" />
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="overflow-auto scrollbar" style="height: 10rem;">
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3" href="{{route('tracki.profile')}}"> <span class="me-2 text-900" data-feather="user"></span><span>Profile</span></a></li>
                                <li class="nav-item"><a class="nav-link px-3" href="{{ route('tracki.employee.dashboard')}}"><span class="me-2 text-900" data-feather="pie-chart"></span>Dashboard</a></li>
                        ...
                        <div class="card-footer p-0 border-top">
                            ...
                            <hr />
                            <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="{{ route('tracki.logout')}}"> <span class="me-2" data-feather="log-out"> </span>Sign out</a></div>
