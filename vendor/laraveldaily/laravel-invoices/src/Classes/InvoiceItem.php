...
class InvoiceItem
{
     ...
     * @var float
     */
    public $leave_days_taken;

    /**
     * @var float
     */
    public $unpaid_leaves;
     ...
     * @var float
     */
    public $total_days_eligible;

    /** end of Timesheet invoice */
    ...
    /**
     * @param float $days_worked
     * @return $this
     */
    public function days_worked(float $days_worked)
    {
    ...
    /**
     * @param float $leave_days_taken
     * @return $this
     */
    public function leave_days_taken(float $leave_days_taken)
    {
    ...
    /**
     * @param float $unpaid_leaves
     * @return $this
     */
    public function unpaid_leaves(float $unpaid_leaves)
    {
    ...
    /**
     * @param float $total_days_eligible
     * @return $this
     */
    public function total_days_eligible(float $total_days_eligible)
    {
        $this->total_days_eligible = $total_days_eligible;
     ...
     * @return $this
     */
    public function daily_rate(float $daily_rate)
    {
     ...
     * @return $this
     */
    public function salary(float $salary)
    {
        $this->salary = $salary;
