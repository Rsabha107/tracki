                                ...
                                <div class="col col-md-auto">
                                    <nav class="nav nav-underline justify-content-end doc-tab-nav align-items-center" role="tablist">
                                        <!-- <button class="btn btn-primary me-4" type="button" data-bs-toggle="modal"
                                            ...
                                            Deal</button> -->
                                        <a class="btn btn-sm btn-phoenix-warning preview-btn ms-2"  href="{{ route('tracki.sec.perm.import') }}"><span class="fa-solid fa-add"></span>Import</a>
                                        <a class="btn btn-sm btn-phoenix-primary preview-btn ms-2"  href="{{ route('tracki.sec.perm.add') }}"><span class="fa-solid fa-add"></span>Add</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-sm table-responsive fs--1 mb-0 overflow-hidden" id="dataList">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="actions">
                                                            <a href="{{route('tracki.sec.perm.edit', $item->id)}}" class="btn btn-sm">
                                                                <i class="fa-solid fa-pen-to-square"></i>
                                                            </a>
                                                            <a href="{{ route('tracki.sec.perm.delete',$item->id)}} " class="btn btn-sm delete" id="delete">
