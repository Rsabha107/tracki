<div class="card mb-4">
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table id="payroll_timesheet_table"
                data-classes="table table-hover  fs-9 mb-0 border-top border-translucent"
                data-toggle="table"
                data-loading-template="loadingTemplate"
                data-url="{{route('tracki.payroll.timesheet.list', $employeeid)}}"
                ...
                <thead>
                    <tr>
                        <!-- <th data-checkbox="true" data-halign="left" data-align="center" data-visible="true"></th> -->
                        ...
                        <th class="align-middle white-space-nowrap fs-9 text-body" data-sortable="true" data-field="employee_number"><?= get_label('employee_number', 'Emp #') ?></th>
                        <th data-sortable="true" data-field="full_name"><?= get_label('full_name', 'Name') ?></th>
                        <th data-sortable="true" data-field="email_address" data-visible="false"><?= get_label('email', 'Email') ?></th>
                        ...
                        <th data-sortable="true" data-field="count_leaves"><?= get_label('leaves_taken', 'Leaves') ?></th>
                        <th data-sortable="true" data-field="count_unpaid"><?= get_label('unpaid_leaves', 'Unpaid') ?></th>
                        <th data-sortable="true" data-field="total_paid_days"><?= get_label('total_paid_days', 'Total Days') ?></th>
                        ...
                        <th data-sortable="true" data-field="reviewed_by_payroll"><?= get_label('reviewed_by_payroll', 'Payroll') ?></th>
