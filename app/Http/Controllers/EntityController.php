...
class EntityController extends Controller
{
    ...
    {
        return view('tracki.setting.entities.list');
    }

    public function get($id)
    {
        $op = EmployeeEntity::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $op = EmployeeEntity::findOrFail($request->id);
    ...
    public function list()
    {
        ...
        $op = EmployeeEntity::orderBy($sort, $order);
    ...
    {
        EmployeeEntity::where('id', '=', $id)->delete();
