...
class EmployeeSponsorshipController extends Controller
{
    //
    public function index()
    {
        return view('tracki.setting.sponsorship.list');
    }

    public function get($id)
    {
        $op = EmployeeSponsorship::findOrFail($id);
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $op = EmployeeSponsorship::findOrFail($request->id);
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            // Log::info($validator->errors());
            $error = true;
            $message = 'Sponsorship could not be created';
        } else {
    ...
    public function list()
    {
        ...
        $op = EmployeeSponsorship::orderBy($sort, $order);
    ...
    {
        EmployeeSponsorship::where('id', '=', $id)->delete();
